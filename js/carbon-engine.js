...
const CarbonEngine = (() => {
  ...
  const TRANSPORT_FACTORS = {
    ...
    flight_long_haul_first: { factor: 0.59, label: "Long-Haul Flight (First)", icon: "✈️" },
  ...
  const DIGITAL_FACTORS = {
    ...
    video_call_sd: 0.04,
    ai_chatbot: 0.03, // ChatGPT, Gemini (per query ~0.001-0.01)
    social_media: 0.004, // Instagram, Twitter browsing
    gaming_cloud: 0.1, // GeForce Now, Xbox Cloud
  ...
  const INDIA_EMAIL_PATTERNS = {
    // Food Delivery
    zomato: {
      senders: ["noreply@zomato.com", "no-reply@zomato.com", "orders@zomato.com"],
      category: "food_delivery",
      platform: "Zomato",
    },
    swiggy: {
      senders: ["no-reply@swiggy.in", "noreply@swiggy.in", "orders@swiggy.in"],
      category: "food_delivery",
      platform: "Swiggy",
    },
    // Quick Commerce
    blinkit: {
      senders: ["noreply@blinkit.com", "support@blinkit.com", "orders@blinkit.com"],
      category: "quick_commerce",
      platform: "Blinkit",
    },
    zepto: {
      senders: ["support@zeptonow.com", "orders@zeptonow.com", "noreply@zeptonow.com"],
      category: "quick_commerce",
      platform: "Zepto",
    },
    dunzo: {
      senders: ["support@dunzo.in", "noreply@dunzo.in"],
      category: "quick_commerce",
      platform: "Dunzo",
    },
    instamart: {
      senders: ["noreply@swiggy.in"],
      category: "quick_commerce",
      platform: "Instamart",
      subjectKeyword: "Instamart",
    },
    bigbasket: {
      senders: ["noreply@bigbasket.com", "care@bigbasket.com"],
      category: "quick_commerce",
      platform: "BigBasket",
    },
    // E-Commerce
    ...
    flipkart: {
      senders: ["noreply@flipkart.com", "seller-notifications@flipkart.com", "track@flipkart.com"],
      category: "ecommerce",
      platform: "Flipkart",
    },
    myntra: {
      senders: ["noreply@myntra.com", "care@myntra.com"],
      category: "ecommerce",
      platform: "Myntra",
    },
    meesho: {
      senders: ["noreply@meesho.com", "support@meesho.com"],
      category: "ecommerce",
      platform: "Meesho",
    },
    ajio: {
      senders: ["noreply@ajio.com", "support@ajio.com"],
      category: "ecommerce",
      platform: "AJIO",
    },
    // Transport - Cabs
    ola: {
      senders: ["no-reply@olacabs.com", "noreply@olacabs.com", "support@olacabs.com"],
      category: "transport_cab",
      platform: "Ola",
    },
    uber: {
      senders: ["uber.india@uber.com", "noreply@uber.com", "receipts@uber.com"],
      category: "transport_cab",
      platform: "Uber",
    },
    rapido: {
      senders: ["noreply@rapido.bike", "support@rapido.bike"],
      category: "transport_cab",
      platform: "Rapido",
    },
    // Transport - Flights
    indigo: {
      senders: ["eticket@goindigo.in", "noreply@goindigo.in", "loyalty@goindigo.in"],
      category: "flight",
      platform: "IndiGo",
    },
    air_india: {
      senders: ["airindia@airindia.in", "noreply@airindia.in", "flyingreturnsenquiry@airindia.in"],
      category: "flight",
      platform: "Air India",
    },
    spicejet: {
      senders: ["bookings@spicejet.com", "noreply@spicejet.com"],
      category: "flight",
      platform: "SpiceJet",
    },
    akasa: {
      senders: ["noreply@akasaair.com", "support@akasaair.com"],
      category: "flight",
      platform: "Akasa Air",
    },
    vistara: {
      senders: ["noreply@airvistara.com", "loyalty@airvistara.com"],
      category: "flight",
      platform: "Vistara",
    },
    // Transport - Train
    irctc: {
      senders: ["donotreply-irctc@irctc.co.in", "irctccare@irctc.co.in", "noreply@irctc.co.in"],
      category: "transport_train",
      platform: "IRCTC",
    },
    // Travel OTAs
    makemytrip: {
      senders: ["support@makemytrip.com", "noreply@makemytrip.com", "bookings@makemytrip.com"],
      category: "travel",
      platform: "MakeMyTrip",
    },
    goibibo: {
      senders: ["noreply@goibibo.com", "bookings@goibibo.com"],
      category: "travel",
      platform: "Goibibo",
    },
    // Accommodation
    oyo: {
      senders: ["service@oyorooms.com", "noreply@oyorooms.com"],
      category: "accommodation",
      platform: "OYO",
    },
    // Electricity Bills
    bescom: {
      senders: ["bescom@bescom.org", "noreply@bescom.org"],
      category: "electricity",
      platform: "BESCOM",
    },
    tata_power: {
      senders: ["customercare@tatapower.com", "noreply@tatapower.com"],
      category: "electricity",
      platform: "Tata Power",
    },
    bses: {
      senders: ["consumercare@bsesdelhi.com", "noreply@bses.in"],
      category: "electricity",
      platform: "BSES Delhi",
    },
    msedcl: {
      senders: ["noreply@mahadiscom.in", "consumer@mahadiscom.in"],
      category: "electricity",
      platform: "MSEDCL",
    },
  };
  ...
  const GLOBAL_EMAIL_PATTERNS = {
    doordash: {
      senders: ["receipts@doordash.com", "no-reply@doordash.com"],
      category: "food_delivery",
      platform: "DoorDash",
    },
    ubereats: {
      senders: ["uber.receipts@uber.com"],
      category: "food_delivery",
      platform: "Uber Eats",
      subjectKeyword: "Eats",
    },
    instacart: {
      senders: ["orders@instacart.com", "receipts@instacart.com"],
      category: "quick_commerce",
      platform: "Instacart",
    },
    amazon_com: {
    ...
    ebay: {
      senders: ["ebay@ebay.com", "member@ebay.com"],
      category: "ecommerce",
      platform: "eBay",
    },
    shopify: {
      senders: ["no-reply@shopify.com", "shopify@shopify.com"],
      category: "ecommerce",
      platform: "Shopify Store",
    },
    united: {
      senders: ["unitedairlines@united.com", "mileageplus@united.com"],
      category: "flight",
      platform: "United Airlines",
    },
    delta: {
      senders: ["delta@e.delta.com", "skymiles@delta.com"],
      category: "flight",
      platform: "Delta",
    },
    american: {
      senders: ["aainfo@aa.com", "advantageinfo@aa.com"],
      category: "flight",
      platform: "American Airlines",
    },
    emirates: {
      senders: ["info@emirates.com", "noreply@emirates.com"],
      category: "flight",
      platform: "Emirates",
    },
    singapore: {
      senders: ["CustomerServices@singaporeair.com.sg"],
      category: "flight",
      platform: "Singapore Airlines",
    },
    lyft: {
      senders: ["no-reply@lyft.com", "receipts@lyft.com"],
      category: "transport_cab",
      platform: "Lyft",
    },
    grab: {
      senders: ["support@grab.com", "no-reply@grab.com"],
      category: "transport_cab",
      platform: "Grab",
    },
  ...
  function calcFoodDelivery(foodType, isQuickCommerce = false, deliveryDistanceKm = 5) {
    ...
    const deliveryCO2 =
      deliveryKm <= 5 ? FOOD_FACTORS.delivery_bike_5km : FOOD_FACTORS.delivery_bike_10km;
  ...
  function calcFlight(distanceKm, flightClass = "economy", includeRFI = true) {
    ...
    if (distanceKm < 500) {
      ...
      switch (flightClass) {
        case "business":
          baseFactor = TRANSPORT_FACTORS.flight_long_haul_biz.factor;
          break;
        case "first":
          baseFactor = TRANSPORT_FACTORS.flight_long_haul_first.factor;
          break;
        default:
          baseFactor = TRANSPORT_FACTORS.flight_long_haul_eco.factor;
      }
    }
